    ...
    def execute(self):
        ...
        for relative_path, reason in sorted(self.conflict.items(), key=lambda p: (p.count('/'), p)):
            if logger.isEnabledFor(logging.WARNING):
                ...
                elif fileinfo := local_fileinfo or remote_fileinfo:
...
def main():
    try:
        ...
        parser.add_argument('-v', '--valid-chars', help="replace invalid [] sftp chars in filenames with ()", default='', action='store_const', const='()')
